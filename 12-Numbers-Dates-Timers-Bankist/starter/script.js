...
console.log(+'23'); // type conversion
...
console.log(Math.max(5, 18, 17, 11, 2));
console.log(Math.max(5, '18', 17, 11, 2));
console.log(Math.max(5, '18px', 17, 11, 2));

console.log(Math.min(5, 18, 17, 11, 2));
...
// THE REMAINDER OPERATOR (% ostatak djeljenja)
console.log(5 % 2);
...
const days1 = calcDaysPassed(new Date(2023, 3, 4), new Date(2023, 3, 14));
console.log(days1);


// INTERNATIONALIZING NUMBERS (INTL)
const num = 8148198.17;
